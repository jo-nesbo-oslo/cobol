...
- **EmployeeReadFileCreateReport.cbl**: Lee el archivo de empleados EMPLOYEE_INPUT_COMP-3.DAT y filtra los empleados con `tipo="E"` para generar el reporte EDITED_EMPLOYEE_REPORT.DAT y el archivo EMPLOYEE_OUTPUT_FILE-COMP-3.DAT.
- **EMPLOYEE-READ-FILE-CREATE-RP1K.cbl**: Lee el archivo de empleados EMPLOYEE_INPUT_COMP-3_1K.DAT y filtra los empleados con `tipo="E"` para generar el reporte EDITED_EMPLOYEE_REPORT_1K.DAT y el archivo EMPLOYEE_OUTPUT_FILE-COMP-3_1K.DAT con los datos procesados.
