       ...
       PROGRAM-ID. EMPLOYEEWITHEDITING.
       AUTHOR.     JARS.
      ***************************************************************
...
-       01 EMPLOYEE-DETAILS.
      ...
      *     05 DET-EMP-LEIDOS      PIC 9,999.
       ...
       0100-PROCESS-RECORDS.
           ...
           PERFORM UNTIL ENDOF-INPUTFILE
              ...
              IF TIPO-EMPLEADO="E"
                PERFORM 0105-PROCESS-RECORDS-TO-WRITE-EMP-E
              END-IF
      ...
      * AFTER ADVANCING 1 LINE.
       ...
       0150-WRITE-TOTAL-CALCULADO.
           DISPLAY "0135-WRITE-TOTAL-CALCULADO".
      ...
      *     WRITE PRINT-LINE AFTER ADVANCING 1 LINE.
           DISPLAY "0150-WRITE-TOTAL-LINE-EMP-LEIDOS".
      *     PERFORM 0128-WRITE-TOTAL-CALCULADO.
       ...
       0200-STOP-RUN.
           ...
           STOP RUN.
           END PROGRAM EMPLOYEEWITHEDITING.
