      ...
      ***************************************************************
       ...
       FILE-CONTROL.
            SELECT EMPLOYEE-FILE ASSIGN TO 
               "./archivos/entrada/EMPLOYEE_INPUT_COMP-3_1K.DAT"
              FILE STATUS IS FILE-CHECK-KEY
              ORGANIZATION IS LINE SEQUENTIAL.
            SELECT PRINT-FILE ASSIGN TO
                "./archivos/salida/EDITED_EMPLOYEE_REPORT_1K.DAT".
            SELECT EMPLOYEE-OUTPUT-FILE ASSIGN TO 
               "./archivos/salida/EMPLOYEE_OUTPUT_FILE-COMP-3_1K.DAT"
              ORGANIZATION IS LINE SEQUENTIAL.
...
-       01 EMPLOYEE-DETAILS.
       ...
       01  WS-WORK-AREAS.
           ...
           05 WS-CALLED_PROGRAM PIC X(20) VALUE "EMPLOYEE-CREATE-F-1K".
      ...
      *>    0010-CALL-EMPLOYEE-CREATE-FILE.
      *>        DISPLAY "Calling EMPLOYEE-CREATE-FILE program..."
      *>        CALL WS-CALLED_PROGRAM.
      *>        DISPLAY "Called EMPLOYEE-CREATE-FILE program..."
      ...
      * AFTER ADVANCING 1 LINE.
       ...
       0200-STOP-RUN.
           ...
           STOP RUN.
           END PROGRAM EMPLOYEE-READ-FILE-CREATE-RP1K.
